...
let icone = 'no'
if (props.styleName === 'google') {
  icone = 'google'
} else if (props.styleName === 'github') {
  icone = 'github'
} else if (props.styleName === 'facebook') {
  icone = 'facebook'
} else if (props.styleName === 'linkedin') {
  icone = 'linkedin'
} else if (props.styleName === 'apple') {
  icone = 'apple'
}
...
<template>
  ...
  >
    ...
    <span class="flex-grow text-center z-10">
      <slot />
    </span>
  </button>
</template>
